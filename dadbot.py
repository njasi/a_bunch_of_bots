...
TRIGGER_STICKERS = [
    ...
    ('CAADAwADEQEAAt8y0wQH4L_Joq0qrQI',['Of course I do I\'m your father']), # u know it daddy uwu
    ...
    ('CAADAwADHwEAAt8y0wQjvZG9HLIgHAI',['Be quiet then','Get me a beer']), # anything you want daddy uwu
...
def im_statements(update):
    ...
    for response in triggers:
        if len(response) != 0:
            BOT.send_message("Hi {}, I'm dad.".format(response.strip(" ")),chat)
